...
class NavigationTest {
    ...
    fun profileScreen_back_conversationScreen() {
        ...
        // Navigate to profile        \
        navigateToProfile("Bukosia Prudence")
    ...
    fun drawer_conversationScreen_backstackPopUp() {
        navigateToProfile("Lumbasi Justus (you)")
        navigateToHome()
        navigateToProfile("Bukosia Prudence")
        navigateToHome()
        navigateToProfile("Akinyi Irene")
        navigateToHome()
        navigateToProfile("Malala S")
        navigateToHome()
    ...
    private fun navigateToHome() {
        ...
        composeTestRule.onNode(hasText("Wanga GDSC") and isInDrawer()).performClick()
    }
